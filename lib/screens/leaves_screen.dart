    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: appCubit.isLoadingFirstLeaves || appCubit.isLoadingLeaveCount
              ? Center(
                  child: CircularProgressIndicator(
                    color: AppColor.primaryColor,
                  ),
                )
              : appCubit.isError ? Container(child: Center(child: Text('something went wrong'),),)
                  ...
                  controller: appCubit.scrollController
                    ..addListener(() async {
                      await appCubit.getLeavesListMoreLoad(
                          ...
                          user.employee!.employeeId,context);
                    }),
                  child: Column(
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return LeaveCard(leave: appCubit.leaves[index],);
                          }),
